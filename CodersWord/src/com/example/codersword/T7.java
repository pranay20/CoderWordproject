...
public class T7 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv=(TextView)findViewById(R.id.t7_tv1);
		tv2=(TextView) findViewById(R.id.t7_tv2);
		Random r=new Random();
		s1="";
		l="";
		int j=0;
		...
		while(it.hasNext())
		  ...
		  if(savedInstanceState==null){
			...
			b[0]=(Button) findViewById(R.id.t7_b1);
			b[1]=(Button) findViewById(R.id.t7_b2);
			b[2]=(Button) findViewById(R.id.t7_b3);
			b[3]=(Button) findViewById(R.id.t7_b4);
			b[4]=(Button) findViewById(R.id.t7_b5);
			b[5]=(Button) findViewById(R.id.t7_b6);
			b[6]=(Button) findViewById(R.id.t7_b7);
			for(int i=0;i<n;i++)
			{
...
b[5].setOnClickListener(new View.OnClickListener() {
	...
	public void onClick(View arg0) {
		// TODO Auto-generated method stub
		b[5].setBackgroundColor(color.buttonclick);
		getString((String) b[5].getText());
		 tv2.setText(s1);
		c++;
...
b[6].setOnClickListener(new View.OnClickListener() {
	...
	public void onClick(View arg0) {
		// TODO Auto-generated method stub
		b[6].setBackgroundColor(color.buttonclick);
		getString((String) b[6].getText());
		 tv2.setText(s1);
		c++;
			...
			progressBar = (ProgressBar) findViewById(R.id.t7_pb1);
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					handler.post(new Runnable() {
						...
						public void run() {
							// TODO Auto-generated method stub
							intent=new Intent(T7.this,Prgc.class);;
						
								if(l.equals("C++")){
									intent=new Intent(T7.this,Prgcp.class);
									}
								else if(l.equals("Java")){
									 intent=new Intent(T7.this,Prgj.class);
								}
								else if(l.equals("C#")){
								 intent=new Intent(T7.this,Prgch.class);
								}
							...
							if(c==n){
								if(s.equals(s1)){
									...
									tv2.setText("");
									for(int i=0;i<n;i++){
										b[i].setBackgroundColor(getResources().getColor(R.color.Button4));
									}
								}
									}
							else{
	...
	public void onBackPressed() {
		...
		cnt++;
		if(cnt==1)
		Toast.makeText(T7.this, "Press again to go back", Toast.LENGTH_SHORT).show();
		if(cnt==2){
			super.onBackPressed();
